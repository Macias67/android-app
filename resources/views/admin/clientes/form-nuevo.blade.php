							  ...
							  <div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											{!! Form::select('categoria_id', $options_categorias, NULL, ['class' => 'form-control select2', 'id' => 'categoria', 'data-url' => route('select-subcategorias')]) !!}
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-offset-3 col-md-9">
											{!! Form::select('subcategoria_id', [], NULL, ['class' => 'form-control select2', 'id' => 'subcategoria']) !!}
										</div>
									</div>
							  </div>
							  <div class="form-actions">
