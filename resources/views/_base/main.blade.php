...
<html lang = "es">
	...
	<head>
		...
		<link href = "{{asset('assets/global/css/components-rounded.min.css')}}" id = "style_components" rel = "stylesheet" type = "text/css"/>
		<link href = "{{asset('assets/global/css/plugins.min.css')}}" rel = "stylesheet" type = "text/css"/>
		<!-- END THEME GLOBAL STYLES -->

		<!-- BEGIN THEME STYLES -->
		<link href = "{{asset('assets/admin/layout4/css/layout.min.css')}}" rel = "stylesheet" type = "text/css"/>
		<link id = "style_color" href = "{{asset('assets/admin/layout4/css/themes/light.min.css')}}" rel = "stylesheet" type = "text/css"/>
		<link href = "{{asset('assets/admin/layout4/css/custom.min.css')}}" rel = "stylesheet" type = "text/css"/>
	...
	<body class = "page-header-fixed page-sidebar-closed-hide-logo page-footer-fixed" token = "{{csrf_token()}}">
						...
						<ul class = "nav navbar-nav pull-right">
							...
							<li class = "dropdown dropdown-user dropdown-dark">
								...
								<ul class = "dropdown-menu dropdown-menu-default">
									...
									<li>
										<a href = ""><i class = "icon-envelope-open"></i> My
											Inbox<span class = "badge badge-danger">3</span></a>
									</li>
									<li>
		...
		<script src = "{{asset('assets/global/plugins/bootstrap-sessiontimeout/bootstrap-session-timeout.min.js')}}" type = "text/javascript"></script>
		<script src = "{{asset('assets/global/plugins/sweetalert/dist/sweetalert.min.js')}}" type = "text/javascript"></script>
		<!-- END PAGE LEVEL PLUGINS -->

		<script src = "{{asset('assets/admin/layout4/scripts/layout.min.js')}}" type = "text/javascript"></script>
		<script src = "{{asset('assets/admin/layout4/scripts/demo.min.js')}}" type = "text/javascript"></script>
		@yield('page-level-js')
		<!-- END JAVASCRIPTS -->
	</body>
	<!-- END BODY -->
