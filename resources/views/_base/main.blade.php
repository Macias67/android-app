                        ...
                        <ul class="nav navbar-nav pull-right">
                              ...
                              <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
                                    ...
                                    <ul class="dropdown-menu">
                                          <li class="external">
                                                <h3><span class="bold">12 pending</span> notifications
                                                </h3>
                                                <a href="">view all</a>
                                          </li>
                                          <li>
                                          ...
                                          <li>
                                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                      <li>
                                                            <a href="">
                                                                        <span class="photo">
                                                                        <img src="{{asset('assets/admin/layout4/img/avatar2.jpg')}}" class="img-circle" alt="">
                                                                        </span>
                                                                        <span class="subject">
                                                                        <span class="from">
                                                                        Lisa Wong </span>
                                                      ...
                                                      <li>
                                                            <a href="">
                                                                        <span class="photo">
                                                                        <img src="{{asset('assets/admin/layout4/img/avatar3.jpg')}}" class="img-circle" alt="">
                                                                        </span>
                                                                        <span class="subject">
                                                                        <span class="from">
                                                                        Richard Doe </span>
                                                      ...
                                                      <li>
                                                            <a href="">
                                                                        <span class="photo">
                                                                        <img src="{{asset('assets/admin/layout4/img/avatar1.jpg')}}" class="img-circle" alt="">
                                                                        </span>
                                                                        <span class="subject">
                                                                        <span class="from">
                                                                        Bob Nilson </span>
                              ...
                              <li class="dropdown dropdown-extended dropdown-tasks dropdown-dark" id="header_task_bar">
                                    ...
                                    <ul class="dropdown-menu extended tasks">
                                          <li class="external">
                                                <h3>You have <span class="bold">12 pending</span> tasks
                                                </h3>
                                                <a href="">view all</a>
                                          </li>
                                          <li>
