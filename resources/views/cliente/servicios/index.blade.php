                ...
                <div class="portlet-body">
                    ...
                    <div class="tiles">
                        <div class="col-md-12">
                            ...
                            @foreach($serviciosMasGustados as $index => $servicio)
                                <div class="layer animated flipInX" style="background-image: url('{{$servicio->imagen}}')">
                                    <div class="portlet light">
                                        <div class="portlet-title">
                                            <div class="caption font-yellow-crusta">
                                                <span class="caption-subject bold font-yellow-crusta uppercase">{{ ($index+1).'. '.$servicio->nombre_servicio}} </span>
                                                <br>
                                            <span class="caption-helper">
                                                <a href="{{route('cliente.negocio.perfil', [$servicio->cliente_id])}}" class="faa-parent animated-icon-hover">
                                                    <i class="fa fa-angle-double-right faa-horizontal"></i> <b>{{$servicio->nombre_cliente}}</b>
                                                </a>
                                            </span>
...
@section('page-level-js')
    {{--<script src="{{asset('assets/admin/pages/app/cliente/servicios/index.js')}}" type="text/javascript"></script>--}}
@stop
