      ...
      <div class="row">
            <div class="col-md-12 animated bounceInUp">
                  ...
                  <div class="profile-sidebar" style="width: 300px;">
                        ...
                        <!-- PORTLET MAIN -->
                      <div class="layer animated flipInX" id="img-servicio" style="background-image: url('{{$img_servicio}}');">
...
@section('page-level-js')
	<script src="{{asset('assets/admin/pages/app/cliente/servicios/edita-servicios.js')}}" type="text/javascript"></script>
	<script src="{{asset('assets/admin/pages/app/cliente/servicios/perfil/logotipo.js')}}" type="text/javascript"></script>
@stop
