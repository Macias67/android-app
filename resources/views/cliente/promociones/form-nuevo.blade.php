        ...
        <div class="col-md-12">
            ...
            <div class="portlet light animated bounceInUp">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-bag"></i>
                        <span class="caption-subject bold uppercase"> Promociones</span>
                        <span class="caption-helper">Registro de Promociones</span>
                    </div>
                    <div class="actions">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="nombre" placeholder="Nombre de la promoción">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="checkbox" class="make-switch" name="siempre"
                                           data-size="small"
                                           data-on-text="Fija" data-off-text="Temporal"
