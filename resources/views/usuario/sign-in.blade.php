...
<html lang="en-US">
	...
	<body onunload="" class="page-subpage page-sign-in navigation-off-canvas" id="page-top">
							...
							<div class="block">
								<div class="row">
									<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
										...
										<hr>
										<h5 style="text-align: center"> o con tu email </h5>
										<hr>
										{!! Form::open($form_login) !!}
											...
											<div class="form-group clearfix">
												<button type="submit" class="btn pull-right btn-default" id="account-submit">Iniciar Sesión</button>
											</div><!-- /.form-group -->
										</form>
									</div>
								</div>
		...
		<script type = "text/javascript" src = "{{asset('assets/tmpl/js/app/login.js')}}"></script>
