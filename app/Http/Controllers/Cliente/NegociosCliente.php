...
class NegociosCliente extends BaseCliente
{
	...
	{
		$upload_dir = ($request->getMethod() === 'GET' or $request->getMethod() === 'DELETE') ?
			Config::get('path.clientes') . '/' . $id_cliente . '/galeria' . '/' :
			Config::get('path.temporal') . '/' . Config::get('path.clientes') . '/' . $id_cliente . '/galeria' . '/';
