...
var NuevoEvento = function () {
	...
	var getAddress = function () {
		...
		var request = function (url) {
			$.get(url, { _token: token}, function (response) {
				var direccion = response.data.calle+' '+response.data.numero+', '+response.data.colonia+', '+response.data.codigo_postal+' '+response.data.ciudad.ciudad+', '+response.data.ciudad.estado;
