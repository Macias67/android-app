			...
			submitHandler : function (e) {
				...
				$.ajax({
					url          : o, type: "POST", data: t, dataType: "json", cache: !1, beforeSend: function () {
						...
						e.setAttribute("src", App.getDomain() + "assets/global/sounds/error.mp3"), e.setAttribute("autoplay", "autoplay"), e.play(), MyApp.removeLoader(500)
					}, statusCode: {
						422   : function (e) {
						...
						MyApp.removeLoader(500, function () {
							...
							t.setAttribute("src", App.getDomain() + "assets/global/sounds/success.mp3"), t.setAttribute("autoplay", "autoplay"), t.play(), swal({
