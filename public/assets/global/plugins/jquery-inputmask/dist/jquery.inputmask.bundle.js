    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function getTests(pos, ndxIntlzr, tstPs, cacheable) {
            function ResolveTestFromToken(maskToken, ndxInitializer, loopNdx, quantifierRecurse) {
                function handleMatch(match, loopNdx, quantifierRecurse) {
                    if (testPos > 1e4) {
                        return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + getMaskSet().mask),
                            !0;
                    }
        ...
        function isValid(pos, c, strict, fromSetValid) {
            ...
            function alternate(pos, c, strict, fromSetValid) {
                ...
                if (void 0 != alternation) {
                    for (var decisionPos in getMaskSet().validPositions) if (altPos = getMaskSet().validPositions[decisionPos],
            ...
            if (result === !1 && opts.keepStatic && isComplete(buffer) && (result = alternate(pos, c, strict, fromSetValid)),
                ...
                if (!postValidResult) {
                    return resetMaskSet(!0), getMaskSet().validPositions = $.extend(!0, {}, positionsClone),
                        !1;
                }
            }
            return result;
        ...
        function caret(input, begin, end) {
            ...
            if ("number" != typeof begin) {
                return npt.setSelectionRange ? (begin = npt.selectionStart,
            ...
            if (begin = TranslatePosition(begin), end = TranslatePosition(end), end = "number" == typeof end ? end : begin,
                ...
                if (npt.scrollLeft = scrollCalc > npt.scrollWidth ? scrollCalc : 0, androidchrome || 0 != opts.insertMode || begin != end || end++,
                    ...
                    npt.createTextRange && (range = npt.createTextRange(), range.collapse(!0),
            ...
            $el.unbind(".inputmask"), ($el.is(":input") && isInputTypeSupported($el.attr("type")) || el.isContentEditable) && ($el.closest("form").bind("submit", function (e) {
                ...
                if ($input.is(":focus")) {
                    ...
                    if (selectedCaret.begin == selectedCaret.end) {
                        if (opts.radixFocus && "" != opts.radixPoint && -1 != $.inArray(opts.radixPoint, getBuffer()) && (firstClick || getBuffer().join("") == getBufferTemplate().join(""))) {
