    ...
    function f(d, e, f) {
        ...
        function o(b, c, d) {
            if (f.insertMode && void 0 != l().validPositions[b] && void 0 == d) {
                ...
                for (e = i = b; h >= e; e++) {
                    var m = g[e];
                    if (void 0 != m) {
                        for (var o = i, p = -1; o < B() && (null == m.match.fn && k[e] && (k[e].match.optionalQuantifier === !0 || k[e].match.optionality === !0) || null != m.match.fn);) {
                    ...
                    if (void 0 != e.matches) {
                        if (e.isGroup && n !== !0) {
                            ...
                            if (-1 == w || "string" == typeof w) {
                                ...
                                e = s.matches[w] ? i(s.matches[w], [w].concat(g), n) : !1;
                            }
                            if (e)return !0
        ...
        function z(b, c, d, e) {
            ...
            function h(b, c, d, e) {
                ...
                if (void 0 != h) {
                    for (var p in l().validPositions)if (j = l().validPositions[p], parseInt(p) > parseInt(g) && void 0 != j.alternation) {
            ...
            if (r < B() && (s = g(r, c, d, e), (!d || e) && s === !1)) {
                ...
                if (!D || null != D.match.fn || D.match.def != c && c != f.skipOptionalPartCharacter) {
                    if ((f.insertMode || void 0 == l().validPositions[C(r)]) && !A(r)) {
                        for (var F = r + 1, H = C(r); H >= F; F++)if (s = g(F, c, d, e), s !== !1) {
                            i(r, F), r = F;
                            break
                        }
                    }
...
//!! the bound handlers are executed in the order they where bound
        ...
        function U(b, c, d, e, g) {
            ...
            if (j) {
                ...
                } : L(h), p = String.fromCharCode(j), q = P(n.begin, n.end);
