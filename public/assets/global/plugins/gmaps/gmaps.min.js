!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        var e = document, o = function (n) {
            ...
            var r, s = this, l = [
                ...
                "tilesloaded",
                "zoom_changed"
            ], p     = ["mousemove", "mouseout", "mouseover"], g = [
                "el",
                "lat",
                "lng",
                "mapType",
                ...
                "markerClusterer",
                "enableNewStyle"
            ], c     = n.el || n.div, h = n.markerClusterer, u = google.maps.MapTypeId[n.mapType.toUpperCase()], d = new google.maps.LatLng(n.lat, n.lng), f = n.zoomControl || !0, m = n.zoomControlOpt || {
                    style: "DEFAULT",
                    position: "TOP_LEFT"
    ...
    l.prototype.createControl = function (e) {
        ...
        for (var i = new google.maps.Polyline(s), a = [
            "click",
            "dblclick",
            "mousedown",
            "mousemove",
        ...
        for (var o = new google.maps.Circle(e), n = [
            "click",
            "dblclick",
            "mousedown",
            "mousemove",
        ...
        e.bounds = o;
        for (var n = new google.maps.Rectangle(e), r = [
            "click",
            "dblclick",
            "mousedown",
            "mousemove",
        ...
        for (var i = new google.maps.Polygon(e), a = [
            "click",
            "dblclick",
            "mousedown",
            "mousemove",
    ...
    return l.prototype.getRoutes = function (e) {
        ...
        if (t.size = e.size || [
                ...
                ], t.lat = this.getCenter().lat(), t.lng = this.getCenter().lng(), this.markers.length > 0) {
            t.markers = [];
        ...
        if (delete e.polyline, e.center) {
            ...
            n.push([
                ...
                ",",
                e.lng
            ].join("")), delete e.lat, delete e.lng;
        } else if (e.visible) {
        ...
        for (var n = [
            ...
            "resize",
            "visible_changed"
        ], r       = t({visible: !0}, e), s = 0; s < n.length; s++)delete r[n[s]];
