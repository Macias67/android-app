...
(function (za, O, l) {
    var N = function (h) {
        ...
        function Da(a) {
            ...
            e = 0;
            for (f = b.length; e < f; e++)if (m = b[e], k = [], !m.sType && m._sManualType) {
                m.sType =
                    m._sManualType;
            } else if (!m.sType) {
                g = 0;
        ...
        function K(a) {
            ...
            if (-1 !== h.inArray(!1, b)) {
                ...
                if (0 !== i.length) {
                    ...
                    c = f.sZeroRecords, 1 == a.iDraw && "ajax" == z(a) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = h("<tr/>", {"class": e ? d[0] : ""}).append(h("<td />", {
                        valign:  "top",
                        colSpan: Z(a),
        ...
        function Ca(a) {
            ...
            if (!o && !f && !e && j == Z(a) && j == i.length) {
                ...
                for (k = 0; k < d.length; k++)if (l = c[d[k]], e = h(i[k]).width()) {
                    l.sWidth =
                        s(e);
                }
        ...
        function Sa(a, b, c, d) {
            ...
            c && a.oFeatures.bSortMulti ? (c = h.inArray(b, C(e, "0")), -1 !== c ? (b = g(e[c]), e[c][1] = f[b], e[c]._idx = b) : (e.push([
                b,
                f[0],
                0
        ...
        function P(a, b, c, d) {
            ...
            } else if (a = p.ext, "alert" == (a.sErrMode || a.errMode))alert(c); else throw Error(c);
        }
        ...
        q.prototype = {
            ...
            iterator:    function (a, b, c) {
                ...
                f = 0;
                for (g = n.length; f < g; f++)if ("table" === b) {
        ...
        var Za = function (a, b) {
            ...
            for (var b = 0, c = a.length; b < c; b++)if (0 < a[b].length) {
                return a[0] =
...
(function (m, k, p) {
    var r = function (n) {
        ...
        TableTools.prototype = {
            ...
            _fnPrintStart:        function (a) {
                ...
                for (e in d)if ("i" != e && "t" != e && 1 == e.length) {
    ...
    "function" === typeof define && define.amd ? define([
        "jquery",
        "datatables"
    ], r) : "object" === typeof exports ? r(require("jquery"), require("datatables")) :
